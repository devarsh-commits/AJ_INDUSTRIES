...
fabContainer.innerHTML = `
  <a href="https://wa.me/918454087989" target="_blank" rel="noopener noreferrer" class="fab-btn whatsapp" aria-label="Chat on WhatsApp">
    <span class="fab-tooltip">WhatsApp: +91 8454 087989</span>
  ...
  <a href="tel:+918454087989" class="fab-btn phone" aria-label="Call +91 8454 087989">
    <span class="fab-tooltip">Call: +91 8454 087989</span>
...
document.querySelectorAll('.topbar span').forEach(span => {
  if (span.textContent.trim().startsWith('+91')) {
    const phone = span.textContent.trim();
    span.innerHTML = `<a href="tel:+918454087989" style="color:inherit;text-decoration:none;">${phone}</a>`;
  }
});
